          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
              <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="text-xs font-bold text-primary uppercase tracking-wider">Reseller Program</span>
              </div>

              <h1 className="font-heading font-black leading-[1.05] mb-5" style={{ fontSize: "clamp(2.2rem, 5vw, 3.8rem)" }}>
                Build Your Own<br /><span className="text-gradient">Streaming Business</span><br />From Scratch
              </h1>
      ...
      <section className="py-20 border-b border-border">
        <div className="container max-w-3xl">
          ...
          <div className="space-y-3">
            {[
              { q: "What exactly is a credit?", a: "One credit activates one month of streaming service for one client. A 1-month subscription uses 1 credit, a 3-month uses 3 credits, a 6-month uses 6, and a 1-year uses 12. Credits are loaded to your panel and used when you create or renew client accounts." },
        ...
        <div className="container text-center max-w-2xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <h2 className="font-heading text-2xl sm:text-3xl md:text-5xl font-black mb-4">
              Start Your <span className="text-gradient">Streaming Business</span> Today
            </h2>
