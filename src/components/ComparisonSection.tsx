    ...
    <div className="container max-w-4xl">
      <div className="text-center mb-10">
        ...
        <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl font-bold">
          <span className="text-gradient">InfinityTV</span> vs Cable & Competitors
        </h2>
        <p className="text-muted-foreground mt-3 max-w-xl mx-auto">
          See exactly why thousands of customers switched from cable and cheap IPTV.
        </p>
      </div>
      ...
      <div className="mt-10 text-center">
        <p className="text-muted-foreground text-sm mb-4">
          Ready to make the switch? Join <strong className="text-foreground">15,000+</strong> subscribers already saving.
        </p>
        <Link href="/#pricing">
          <Button className="bg-gradient-primary text-white font-bold hover:opacity-90 shadow-glow px-8 rounded-full">
            Start Now — from $4.91/mo →
          </Button>
        </Link>
      </div>
    </div>
